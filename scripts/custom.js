	...
	function findItems(itemSearch) {
		//with postal code
		//var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=50&PostalCode=91411&SortOrder=Ascending&callname=FindItems&QueryKeywords=" + itemSearch + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
		var itemSearchFormatted = makeSearchString(itemSearch);
		var zipcode = getZipcode();
		if (zipcode !== "") {
			var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=50&PostalCode=" + zipcode + "&SortOrder=Ascending&callname=FindItems&QueryKeywords=" + itemSearchFormatted + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
		} else {
			var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=50&SortOrder=Ascending&callname=FindItems&QueryKeywords=" + itemSearchFormatted + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
		}
	...
	function findItemsAdvanced(itemSearch,pageNumber) {
		...
		if (zipcode !== "") {
			...
			if (pageNumber) {
				...
				var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=50&BidCountMax=0&SortOrder=Ascending&callname=FindItemsAdvanced&QueryKeywords=" + itemSearchFormatted + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
			}
		}
		var script = document.createElement('script');
		script.type = 'text/javascript';
	...
	function getHalfProduct(itemSearch,type,pageNumber) {
		if (pageNumber) {
			var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=20&IncludeSelector=Items&AvailableItemsOnly=true&PageNumber=" + pageNumber + "&SortOrder=Ascending&callname=FindHalfProducts&ProductID.type="+type+"&ProductID.Value=" + itemSearch + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
		} else {
			var source = "http://open.api.ebay.com/shopping?appid=CodeCoal-4e45-426e-9e6e-7a8cab1f6e16&version=517&siteid=0&MaxEntries=20&IncludeSelector=Items&AvailableItemsOnly=true&SortOrder=Ascending&callname=FindHalfProducts&ProductID.type="+type+"&ProductID.Value=" + itemSearch + "&responseencoding=JSON&callback=true&trackingid=5336112370&trackingpartnercode=9";
		}
		var script = document.createElement('script');
		script.type = 'text/javascript';
		script.id = 'halfSearch';
