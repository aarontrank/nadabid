...
<link rel="stylesheet" type="text/css" media="screen" href="css/half.css" />
	...
	<div align="center">
		<table class="main_table" cellpadding="0" cellspacing="0" border="0">
			...
			<tr><td>
				<div id="content" class="content">
					<div>
						<div style="float:left; position:relative; bottom: -2px; left: 10px; z-index:1;"><a onclick="javascript:runSearch('index.php')"><img src="images/ebayunsel.gif"/></a></div>
						<div align="left" style="position:relative; bottom: -2px; left: 10px;"><img src="images/halfsel.gif"/></div>
						<div id="search_bar" class="search_bar">
							<table width="100%">
							<tr>
							<td align="left">
								<form action="javascript:runSearch('half.php')">
					...
					<div class="inner_content">
						...
						<div>
							...
							<div id="sidebar_right" class="sidebar" style="float: right; margin-right: 10px;">
								<a target="_blank" href="http://rover.ebay.com/rover/1/711-1751-2978-328/1?aid=10366500&pid=2687640">
																	<img width="120" height="600" border="0" alt="" src="http://www.lduhtrp.net/image-2687640-10366500"/>
																</a>
							</div>
						</div>
					</div>
			...
			<tr><td><div id="footer" class="footer" align="center">
				<a href="http://rover.ebay.com/rover/1/711-1751-2978-328/1?aid=10366506&pid=2687640" target="_blank">
					<!-- width="728" -->
					<img src="http://www.lduhtrp.net/image-2687640-10366506" width="780" height="90" alt="" border="0"/>
				</a>
				</div>
				<img src="images/half/bottom.gif"></td></tr>
		</table>
		<table style="width:780px;">
			<tr>
				...
				<td align="right" valign="baseline"><a href="http://www.codecoalition.com"><img src="images/half/codecoalitionproject.gif" style="border: none;" alt="This is a Code Coalition project"/></a></td>
			</tr>
		</table>
	</div>
	
  	<form id="searchForm" action="half.php" method="get" style="visibility: hidden; height:1px;">
  		<input id="searchField" name="search" type="hidden"  value="<?php 
																		if ($_GET["search"] != "") {
																			echo $_GET["search"];
																		} 
																	  ?>" ></input>
  		<input id="itemSearch" name="item" type="hidden" value="<?php 
																		if ($_GET["item"] != "") {
																			echo $_GET["item"];
																		} 
																	  ?>" ></input>
  		<input id="searchType" name="type" type="hidden" value="<?php 
																		if ($_GET["type"] != "") {
																			echo $_GET["type"];
																		} 
																	  ?>"></input>
